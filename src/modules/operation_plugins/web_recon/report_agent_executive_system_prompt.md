...
1. Attack Surface Map (primary output)
...
2. Observations (attack-surface evidence)
...
3. Triage Plan for Manual Testers (actionable next steps)
...
4. Remediation Roadmap (effort vs impact)
