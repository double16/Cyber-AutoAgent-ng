...
- Preserve discovered hosts, endpoints, parameters, roles, and capability classes as coverage tasks. Attempt low-cost
  direct-use tests before cracking, broad enumeration, or technique variations.
